...
> Report: `research/V3_RESEARCH_REPORT.md` (§51 structure: Abstract→Limitations, Abstract tied to §51) — `research/questions/RQs.md` (RQs 1–5) → `research/experiments/` (ablation A–F) → `research/results/` (immutable §74 under `release/v3.0`) → `research/figures/` + `research/tables/` + `research/paper/` (V2 draft preserved as history).
...
`benchmarks/v2/` — 30 CSVs + `catalog.json 0.3.0` (100 tasks over 11 categories) — see `docs/benchmark.md` + `benchmarks/v2/README.md` (§50) + `docs/v3/BENCHMARK_AUDIT.md`.
...
Statistical rigour: `docs/v3/STATISTICAL_EVALUATION.md` (S01–S10).
